...
date > time.txt; python ./pytorch/train.py train --config_path=./configs/nuscenes/20_epochs/car-test.fhd.config --model_dir=model_car_40_epochs --measure_time=True; date >> time.txt; mv time.txt model_car_40_epochs
