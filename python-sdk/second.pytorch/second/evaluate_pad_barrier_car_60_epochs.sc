...
date > time.txt; python ./pytorch/train.py evaluate --config_path=./configs/nuscenes/60_epochs/barrier-test.fhd.config --model_dir=model_barrier_60_epochs --measure_time=True; date >> time.txt; mv time.txt model_barrier_60_epochs
